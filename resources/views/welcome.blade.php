...
<!-- Mirrored from kofejob.dreamguystech.com/template/index-five.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 06 Feb 2023 22:12:04 GMT -->

<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, user-scalable=0">
    <title>SpeedServe</title>
...
<body class="home-page body-five">
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            ...
                            <div class="social-icon icon-list">
                                <ul>
                                    <li><a href="#" class="icon" target="_blank"><i
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="footer-widget footer-menu">
                                ...
                                <ul class="address-box">
                                    <li><i class="fas fa-map-marker-alt"></i> 3556 Beech Street, San Francisco,
                                        California, CA 94108.</li>
                                    <li><i class="fas fa-phone-alt"></i> +154 6546 5640</li>
                                    <li><i class="far fa-envelope"></i><a
                                            href="https://kofejob.dreamguystech.com/cdn-cgi/l/email-protection"
                                            class="__cf_email__"
                                            data-cfemail="a4efcbc2c1cecbc6e4c3c9c5cdc88ac7cbc9">[email&#160;protected]</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
    ...
    <script data-cfasync="false"
        src="https://kofejob.dreamguystech.com/cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script>
